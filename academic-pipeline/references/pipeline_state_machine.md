...
| INIT | Stage 5 | User has final draft for format conversion or Chinese university thesis formatting | Confirm format requirements, launch format-convert |
...
| Chinese university thesis LaTeX/PDF/DOCX-via-Pandoc output | Stage 5 | END (delivery) | Optional when user selects a Chinese university thesis template profile |
